    ...
    with open('fueldataset2.csv', newline="\r\n") as csvfile:
        ...
        for row in spamreader:
            if row and row[0]!='frame_order':
                new_element = [row[0],row[1]]
                fueldata.append(new_element)
                fueldata_ids.append(1);
    if data_limit is None:
        return (fueldata,fueldata_ids)
    else:
        return (fueldata[0::data_limit],fueldata_ids[0::data_limit])
    

fueldata_dataset = get_csv_data(10)

#print (fueldata_dataset)
#sys.exit()
